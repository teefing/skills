...
def update_field(app_token, table_id, field_id, field_json):
    ...
    return client.call("UpdateAppTableField", args)


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Update a field in a Bitable table.")
    ...
    run_script(update_field, parsed.app_token, parsed.table_id, parsed.field_id, parsed.field)
